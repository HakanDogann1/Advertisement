using Advertisement.DataAccess.Configurations;
...
namespace Advertisement.DataAccess.Contexts
{
    public class AdvertisementContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new ProvidedAdvertisementConfiguration());
            modelBuilder.ApplyConfiguration(new ProvidedServiceConfiguration());
        }
        public DbSet<ProvidedAdvertisement> ProvidedAdvertisements { get; set; }
