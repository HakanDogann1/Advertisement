    ...
    public partial class mig1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvidedAdvertisements", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProvidedAdvertisementId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementAppUsers_ProvidedAdvertisements_ProvidedAdvertisementId",
                        column: x => x.ProvidedAdvertisementId,
                        principalTable: "ProvidedAdvertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementAppUsers_AppUserId_ProvidedAdvertisementId",
                table: "AdvertisementAppUsers",
                columns: new[] { "AppUserId", "ProvidedAdvertisementId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementAppUsers_ProvidedAdvertisementId",
                table: "AdvertisementAppUsers",
                column: "ProvidedAdvertisementId");
